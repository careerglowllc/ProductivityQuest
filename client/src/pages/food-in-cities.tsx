...
const SEED_ENTRIES: FoodEntry[] = [
  ...
  {
    id: "food-spectra-coffee-sanjose",
    name: "Spectra Coffee",
    city: "San Jose, CA",
    address: "5353 Almaden Expy #52, San Jose, CA 95118",
    overallRating: 4.5,
    stars: { food: 3, ambience: 3.5, price: 4 },
    thoughts: "Great coffee and has a good mix of seasonal drinks and classic drinks. No decaf espresso for some reason though. Food options are fine but not mind-blowing. Cafe is serviceable for in-person work but a bit small.",
  ...
  {
    id: "food-tuk-tuk-chicken-rice-sanjose",
    name: "Tuk Tuk Chicken & Rice",
    city: "San Jose, CA",
    address: "5663 Snell Ave, San Jose, CA 95123",
    overallRating: 3.7,
    stars: { food: 3.7, ambience: 4, price: 4.5 },
    thoughts: "Solid authentic Thai food. Love the Thai basil and mango sticky rice. Reasonable price. Food is good but not spectacular.",
    tags: ["Thai", "Casual"],
    visitedAt: "",
