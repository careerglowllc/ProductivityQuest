            ...
            <div className="flex-1 min-w-0">
              <AttachmentArea attachments={draftAttachments} onChange={setDraftAttachments} showHint={false}>
                <Input
                  ...
                  className="bg-slate-800/60 border-pink-600/30 text-pink-50 placeholder:text-slate-500 pr-10"
                />
              </AttachmentArea>
            </div>
                    ...
                    <CardContent className="p-4 space-y-3">
                      <AttachmentArea attachments={editAttachments} onChange={setEditAttachments}>
                        <Textarea
                          ...
                          className="bg-slate-900/60 border-pink-600/30 text-pink-50 placeholder:text-slate-500 min-h-[80px] pr-10"
                          autoFocus
                        />
                      </AttachmentArea>
