...
import { Zap, ArrowLeft, Plus, Trash2, Search, Download, Pencil, Check, X, Undo2, Redo2 } from "lucide-react";
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex gap-2 mb-6">
            ...
            <Button
              ...
              className={`shrink-0 ${lastRedo ? "border-orange-500/60 text-orange-300 hover:bg-orange-600/20 hover:text-orange-100" : "border-slate-700 text-slate-600"}`}
            >
