...
const EMOJI_DATA: Array<{ emoji: string; keywords: string[] }> = [
  ...
  { emoji: "💇", keywords: ["haircut", "hair", "salon", "barber", "cut", "grooming", "trim", "style"] },
  { emoji: "💇‍♂️", keywords: ["man", "haircut", "hair", "barber", "cut", "grooming", "trim"] },
  { emoji: "💇‍♀️", keywords: ["woman", "haircut", "hair", "salon", "cut", "grooming", "trim", "style"] },
