...
const EMOJI_DATA: Array<{ emoji: string; keywords: string[] }> = [
  ...
  // Families, Children, Couples, Groups
  { emoji: "👶", keywords: ["baby", "infant", "child", "newborn", "face", "kid", "toddler"] },
  { emoji: "🧒", keywords: ["child", "kid", "young", "face", "gender neutral", "children"] },
  { emoji: "👦", keywords: ["boy", "child", "kid", "young", "face", "male", "son"] },
  { emoji: "👧", keywords: ["girl", "child", "kid", "young", "face", "female", "daughter"] },
  { emoji: "🧒", keywords: ["kid", "child", "young", "face", "children", "school"] },
  { emoji: "👨‍👩‍👦", keywords: ["family", "man", "woman", "boy", "parents", "child", "son", "dad", "mom"] },
  { emoji: "👨‍👩‍👧", keywords: ["family", "man", "woman", "girl", "parents", "child", "daughter", "dad", "mom"] },
  { emoji: "👨‍👩‍👧‍👦", keywords: ["family", "man", "woman", "girl", "boy", "parents", "children", "kids", "dad", "mom"] },
  { emoji: "👨‍👩‍👦‍👦", keywords: ["family", "man", "woman", "boys", "parents", "children", "sons", "dad", "mom"] },
  { emoji: "👨‍👩‍👧‍👧", keywords: ["family", "man", "woman", "girls", "parents", "children", "daughters", "dad", "mom"] },
  { emoji: "👩‍👦", keywords: ["family", "woman", "boy", "mother", "son", "mom", "single mom", "parent"] },
  { emoji: "👩‍👧", keywords: ["family", "woman", "girl", "mother", "daughter", "mom", "single mom", "parent"] },
  { emoji: "👩‍👧‍👦", keywords: ["family", "woman", "girl", "boy", "mother", "children", "mom", "single mom"] },
  { emoji: "👩‍👦‍👦", keywords: ["family", "woman", "boys", "mother", "sons", "mom", "single mom"] },
  { emoji: "👩‍👧‍👧", keywords: ["family", "woman", "girls", "mother", "daughters", "mom", "single mom"] },
  { emoji: "👨‍👦", keywords: ["family", "man", "boy", "father", "son", "dad", "single dad", "parent"] },
  { emoji: "👨‍👧", keywords: ["family", "man", "girl", "father", "daughter", "dad", "single dad", "parent"] },
  { emoji: "👨‍👧‍👦", keywords: ["family", "man", "girl", "boy", "father", "children", "dad", "single dad"] },
  { emoji: "👨‍👦‍👦", keywords: ["family", "man", "boys", "father", "sons", "dad", "single dad"] },
  { emoji: "👨‍👧‍👧", keywords: ["family", "man", "girls", "father", "daughters", "dad", "single dad"] },
  { emoji: "👫", keywords: ["couple", "man", "woman", "holding hands", "date", "relationship", "partner"] },
  { emoji: "👬", keywords: ["couple", "men", "holding hands", "date", "relationship", "partner"] },
  { emoji: "👭", keywords: ["couple", "women", "holding hands", "date", "relationship", "partner"] },
  { emoji: "🧑‍🤝‍🧑", keywords: ["people", "holding hands", "couple", "friends", "partner", "together"] },
  { emoji: "💑", keywords: ["couple", "heart", "love", "relationship", "romance", "partner"] },
  { emoji: "👩‍❤️‍👨", keywords: ["couple", "heart", "woman", "man", "love", "relationship"] },
  { emoji: "👨‍❤️‍👨", keywords: ["couple", "heart", "men", "love", "relationship"] },
  { emoji: "👩‍❤️‍👩", keywords: ["couple", "heart", "women", "love", "relationship"] },
  { emoji: "💏", keywords: ["couple", "kiss", "love", "relationship", "romance"] },
  { emoji: "👪", keywords: ["family", "parents", "child", "group", "household", "home"] },
  { emoji: "🫄", keywords: ["pregnant", "person", "expecting", "baby", "parent"] },
  { emoji: "🫃", keywords: ["pregnant", "man", "expecting", "baby", "parent"] },
  { emoji: "🤰", keywords: ["pregnant", "woman", "expecting", "baby", "mother", "mom"] },
  { emoji: "🤱", keywords: ["breastfeeding", "nursing", "baby", "mother", "mom", "infant", "feed"] },
  { emoji: "👼", keywords: ["angel", "baby", "cherub", "child", "innocent", "cute"] },
  { emoji: "🧒", keywords: ["child", "kid", "face", "young", "school", "children"] },
  { emoji: "👨‍🍼", keywords: ["man", "baby", "bottle", "father", "dad", "feeding", "parent", "infant"] },
  { emoji: "👩‍🍼", keywords: ["woman", "baby", "bottle", "mother", "mom", "feeding", "parent", "infant"] },
  { emoji: "🧑‍🍼", keywords: ["person", "baby", "bottle", "feeding", "parent", "infant", "caregiver"] },
  { emoji: "🧑‍🦯", keywords: ["person", "cane", "blind", "accessibility", "disability"] },
  { emoji: "🧑‍🦼", keywords: ["person", "wheelchair", "motorized", "accessibility", "disability"] },
  { emoji: "🧑‍🦽", keywords: ["person", "wheelchair", "manual", "accessibility", "disability"] },
  { emoji: "👨‍👨‍👦", keywords: ["family", "men", "boy", "two dads", "parents", "child", "son"] },
  { emoji: "👨‍👨‍👧", keywords: ["family", "men", "girl", "two dads", "parents", "child", "daughter"] },
  { emoji: "👨‍👨‍👧‍👦", keywords: ["family", "men", "girl", "boy", "two dads", "parents", "children"] },
  { emoji: "👩‍👩‍👦", keywords: ["family", "women", "boy", "two moms", "parents", "child", "son"] },
  { emoji: "👩‍👩‍👧", keywords: ["family", "women", "girl", "two moms", "parents", "child", "daughter"] },
  { emoji: "👩‍👩‍👧‍👦", keywords: ["family", "women", "girl", "boy", "two moms", "parents", "children"] },

  // More People Faces — Skin Tone Variants & Diversity
  { emoji: "👨🏻", keywords: ["man", "male", "face", "light skin", "person"] },
  { emoji: "👨🏽", keywords: ["man", "male", "face", "medium skin", "person"] },
  { emoji: "👨🏾", keywords: ["man", "male", "face", "dark skin", "person"] },
  { emoji: "👨🏿", keywords: ["man", "male", "face", "dark skin", "person"] },
  { emoji: "👩🏻", keywords: ["woman", "female", "face", "light skin", "person"] },
  { emoji: "👩🏽", keywords: ["woman", "female", "face", "medium skin", "person"] },
  { emoji: "👩🏾", keywords: ["woman", "female", "face", "dark skin", "person"] },
  { emoji: "👩🏿", keywords: ["woman", "female", "face", "dark skin", "person"] },
  { emoji: "🧑🏻", keywords: ["person", "face", "light skin", "gender neutral"] },
  { emoji: "🧑🏽", keywords: ["person", "face", "medium skin", "gender neutral"] },
  { emoji: "🧑🏾", keywords: ["person", "face", "dark skin", "gender neutral"] },
  { emoji: "🧑🏿", keywords: ["person", "face", "dark skin", "gender neutral"] },
  { emoji: "👶🏻", keywords: ["baby", "infant", "light skin", "child", "face"] },
  { emoji: "👶🏽", keywords: ["baby", "infant", "medium skin", "child", "face"] },
  { emoji: "👶🏾", keywords: ["baby", "infant", "dark skin", "child", "face"] },
  { emoji: "👶🏿", keywords: ["baby", "infant", "dark skin", "child", "face"] },
  { emoji: "👧🏻", keywords: ["girl", "child", "light skin", "kid", "face", "daughter"] },
  { emoji: "👧🏽", keywords: ["girl", "child", "medium skin", "kid", "face", "daughter"] },
  { emoji: "👧🏾", keywords: ["girl", "child", "dark skin", "kid", "face", "daughter"] },
  { emoji: "👦🏻", keywords: ["boy", "child", "light skin", "kid", "face", "son"] },
  { emoji: "👦🏽", keywords: ["boy", "child", "medium skin", "kid", "face", "son"] },
  { emoji: "👦🏾", keywords: ["boy", "child", "dark skin", "kid", "face", "son"] },

  // People Roles & Activities
  { emoji: "🧑‍🎤", keywords: ["singer", "person", "music", "rockstar", "performer", "band"] },
  { emoji: "👨‍🎤", keywords: ["man", "singer", "music", "rockstar", "performer", "band"] },
  { emoji: "👩‍🎤", keywords: ["woman", "singer", "music", "rockstar", "performer", "band"] },
  { emoji: "🧑‍🏫", keywords: ["teacher", "person", "instructor", "school", "educate", "professor"] },
  { emoji: "👨‍🏫", keywords: ["man", "teacher", "instructor", "school", "educate", "professor"] },
  { emoji: "👩‍🏫", keywords: ["woman", "teacher", "instructor", "school", "educate", "professor"] },
  { emoji: "🧑‍⚕️", keywords: ["doctor", "person", "nurse", "medical", "health", "hospital"] },
  { emoji: "👨‍⚕️", keywords: ["man", "doctor", "nurse", "medical", "health", "hospital"] },
  { emoji: "👩‍⚕️", keywords: ["woman", "doctor", "nurse", "medical", "health", "hospital"] },
  { emoji: "🧑‍🍳", keywords: ["chef", "person", "cook", "food", "kitchen", "restaurant"] },
  { emoji: "👨‍🍳", keywords: ["man", "chef", "cook", "food", "kitchen", "restaurant"] },
  { emoji: "👩‍🍳", keywords: ["woman", "chef", "cook", "food", "kitchen", "restaurant"] },
  { emoji: "🧑‍🔧", keywords: ["mechanic", "person", "fix", "repair", "tool", "plumber", "handyman"] },
  { emoji: "👨‍🔧", keywords: ["man", "mechanic", "fix", "repair", "tool", "plumber", "handyman"] },
  { emoji: "👩‍🔧", keywords: ["woman", "mechanic", "fix", "repair", "tool", "plumber"] },
  { emoji: "🧑‍🌾", keywords: ["farmer", "person", "farm", "agriculture", "garden", "plant", "grow"] },
  { emoji: "👨‍🌾", keywords: ["man", "farmer", "farm", "agriculture", "garden", "plant", "grow"] },
  { emoji: "👩‍🌾", keywords: ["woman", "farmer", "farm", "agriculture", "garden", "plant", "grow"] },
  { emoji: "🧑‍💻", keywords: ["developer", "person", "programmer", "coder", "tech", "computer"] },
  { emoji: "👨‍💻", keywords: ["man", "developer", "programmer", "coder", "tech", "computer"] },
  { emoji: "👩‍💻", keywords: ["woman", "developer", "programmer", "coder", "tech", "computer"] },
  { emoji: "🧑‍🎓", keywords: ["student", "person", "graduate", "school", "study", "learn", "education"] },
  { emoji: "👨‍🎓", keywords: ["man", "student", "graduate", "school", "study", "learn"] },
  { emoji: "👩‍🎓", keywords: ["woman", "student", "graduate", "school", "study", "learn"] },
  { emoji: "🧑‍🚒", keywords: ["firefighter", "person", "fire", "rescue", "emergency", "hero"] },
  { emoji: "👨‍🚒", keywords: ["man", "firefighter", "fire", "rescue", "emergency", "hero"] },
  { emoji: "👩‍🚒", keywords: ["woman", "firefighter", "fire", "rescue", "emergency", "hero"] },
  { emoji: "👷", keywords: ["construction", "worker", "hard hat", "build", "person", "site"] },
  { emoji: "👷‍♂️", keywords: ["man", "construction", "worker", "hard hat", "build", "site"] },
  { emoji: "👷‍♀️", keywords: ["woman", "construction", "worker", "hard hat", "build", "site"] },
  { emoji: "💂", keywords: ["guard", "soldier", "military", "royal", "person", "british"] },
  { emoji: "💂‍♂️", keywords: ["man", "guard", "soldier", "military", "royal", "british"] },
  { emoji: "💂‍♀️", keywords: ["woman", "guard", "soldier", "military", "royal", "british"] },
  { emoji: "👮", keywords: ["police", "officer", "cop", "law", "person", "enforcement"] },
  { emoji: "👮‍♂️", keywords: ["man", "police", "officer", "cop", "law", "enforcement"] },
  { emoji: "👮‍♀️", keywords: ["woman", "police", "officer", "cop", "law", "enforcement"] },
  { emoji: "🕵️", keywords: ["detective", "spy", "investigate", "person", "sleuth", "private eye"] },
  { emoji: "🕵️‍♂️", keywords: ["man", "detective", "spy", "investigate", "sleuth"] },
  { emoji: "🕵️‍♀️", keywords: ["woman", "detective", "spy", "investigate", "sleuth"] },
  { emoji: "🧑‍✈️", keywords: ["pilot", "person", "airplane", "captain", "fly", "aviation"] },
  { emoji: "👨‍✈️", keywords: ["man", "pilot", "airplane", "captain", "fly", "aviation"] },
  { emoji: "👩‍✈️", keywords: ["woman", "pilot", "airplane", "captain", "fly", "aviation"] },
  { emoji: "🧑‍🚀", keywords: ["astronaut", "person", "space", "nasa", "cosmonaut", "rocket"] },
  { emoji: "👨‍🚀", keywords: ["man", "astronaut", "space", "nasa", "cosmonaut", "rocket"] },
  { emoji: "👩‍🚀", keywords: ["woman", "astronaut", "space", "nasa", "cosmonaut", "rocket"] },
  { emoji: "🧑‍⚖️", keywords: ["judge", "person", "law", "court", "justice", "legal"] },
  ...
  // Medical / Clinical
  { emoji: "😷", keywords: ["mask", "medical", "face mask", "sick", "ill", "covid", "virus", "infection", "protection", "surgical mask"] },
  { emoji: "🤒", keywords: ["sick", "fever", "ill", "thermometer", "face", "temperature", "unwell"] },
  { emoji: "🤕", keywords: ["hurt", "injured", "bandage", "head", "wound", "pain", "face"] },
  { emoji: "🤧", keywords: ["sneeze", "sick", "cold", "tissue", "flu", "allergy", "blow", "nose"] },
  { emoji: "🩻", keywords: ["xray", "x-ray", "scan", "bone", "skeleton", "radiology", "imaging", "medical"] },
  { emoji: "🩹", keywords: ["bandage", "bandaid", "wound", "cut", "heal", "injury", "adhesive", "plaster"] },
  { emoji: "🏥", keywords: ["hospital", "medical", "health", "emergency", "clinic", "building"] },
  { emoji: "🚑", keywords: ["ambulance", "emergency", "ems", "hospital", "rescue", "medical"] },
  { emoji: "🩸", keywords: ["blood", "drop", "medical", "donate", "test", "lab", "transfusion"] },
  { emoji: "🧪", keywords: ["test tube", "lab", "science", "experiment", "chemistry", "medical", "sample"] },
  { emoji: "🔬", keywords: ["microscope", "lab", "science", "research", "biology", "pathology", "medical"] },
  { emoji: "💉", keywords: ["syringe", "needle", "injection", "vaccine", "iv", "shot", "blood draw", "medical", "catheter"] },
  { emoji: "🩼", keywords: ["crutch", "crutches", "injury", "broken", "leg", "mobility", "recovery", "medical"] },
  { emoji: "🦽", keywords: ["wheelchair", "manual", "disability", "mobility", "medical", "accessibility"] },
  { emoji: "🦼", keywords: ["wheelchair", "motorized", "electric", "disability", "mobility", "medical"] },
  { emoji: "🦯", keywords: ["cane", "blind", "sight", "white cane", "vision", "mobility", "disability"] },
  { emoji: "🫁", keywords: ["lungs", "breath", "breathing", "respiratory", "ventilator", "oxygen", "copd", "medical"] },
  { emoji: "🫀", keywords: ["heart", "cardiac", "cardiology", "organ", "pulse", "beat", "medical"] },
  { emoji: "🧠", keywords: ["brain", "neurology", "neuro", "mental", "cognitive", "mind", "medical"] },
  { emoji: "🦷", keywords: ["tooth", "teeth", "dental", "dentist", "oral", "mouth", "medical"] },
  { emoji: "🦴", keywords: ["bone", "skeleton", "orthopedic", "fracture", "break", "medical"] },
  { emoji: "💊", keywords: ["pill", "medicine", "drug", "pharmacy", "medication", "tablet", "capsule", "rx", "medical"] },
  { emoji: "🩺", keywords: ["stethoscope", "doctor", "checkup", "listen", "heartbeat", "medical", "hospital"] },
  { emoji: "🔋", keywords: ["battery", "pacemaker", "device", "charge", "medical", "implant"] },
  { emoji: "🧲", keywords: ["magnet", "mri", "scan", "imaging", "pull", "medical"] },
  { emoji: "⚗️", keywords: ["flask", "lab", "chemistry", "experiment", "compound", "medication", "pharmacy", "medical"] },
  { emoji: "🧴", keywords: ["lotion", "sanitizer", "cream", "skin", "topical", "medical", "ointment"] },
  { emoji: "🩱", keywords: ["compression", "garment", "medical", "surgery", "post-op", "binder"] },
  { emoji: "🔩", keywords: ["screw", "bolt", "hardware", "surgical", "implant", "orthopedic", "medical"] },
  ...
  { emoji: "☀️", keywords: ["sun", "sunny", "weather", "bright", "day", "warm", "summer", "solar", "solar panel", "energy", "renewable", "photovoltaic"] },
  ...
  { emoji: "🔆", keywords: ["solar", "solar panel", "panel", "photovoltaic", "brightness", "bright", "sun", "energy", "renewable", "power", "high"] },
  { emoji: "🌞", keywords: ["sun", "solar", "solar panel", "energy", "renewable", "bright", "warm", "summer", "face"] },
  { emoji: "🪫", keywords: ["battery", "low battery", "empty", "drained", "dead", "power", "charge", "energy"] },
  { emoji: "🌬️", keywords: ["wind", "wind turbine", "windmill", "energy", "renewable", "blow", "breeze", "air", "gust"] },
  { emoji: "💨", keywords: ["wind", "dash", "air", "blow", "gust", "fast", "energy", "breeze"] },
  { emoji: "🏭", keywords: ["factory", "power plant", "industrial", "energy", "emissions", "pollution", "manufacturing", "smoke"] },
  { emoji: "🛢️", keywords: ["oil", "barrel", "drum", "fuel", "petroleum", "fossil fuel", "energy", "gas"] },
  { emoji: "🌡️", keywords: ["thermometer", "temperature", "heat", "climate", "weather", "energy", "hot", "cold"] },
  { emoji: "🧯", keywords: ["fire extinguisher", "safety", "emergency", "fire", "put out", "hazard"] },
  { emoji: "🌍", keywords: ["earth", "world", "globe", "environment", "eco", "climate", "green", "planet", "renewable"] },
  ...
  // Grooming, Hygiene & Daily Care
  { emoji: "🪥", keywords: ["toothbrush", "teeth", "dental", "brush", "hygiene", "clean", "chore", "morning", "night", "routine"] },
  { emoji: "🧴", keywords: ["moisturizer", "lotion", "bottle", "cream", "sunscreen", "skincare", "hygiene", "face", "body", "routine", "spf"] },
  { emoji: "🧼", keywords: ["soap", "bar", "wash", "hand", "hygiene", "clean", "shower", "bath", "body wash"] },
  { emoji: "🫧", keywords: ["bubbles", "soap", "lather", "foam", "clean", "wash", "hygiene", "bath", "shampoo"] },
  { emoji: "🪒", keywords: ["razor", "shave", "shaving", "grooming", "hygiene", "blade", "face", "legs", "beard"] },
  ...
  { emoji: "💆", keywords: ["massage", "face", "spa", "relax", "facial", "skincare", "self care"] },
  { emoji: "💆‍♂️", keywords: ["man", "massage", "face", "spa", "relax", "facial", "self care"] },
  { emoji: "💆‍♀️", keywords: ["woman", "massage", "face", "spa", "relax", "facial", "self care"] },
  { emoji: "🧖", keywords: ["sauna", "steam", "spa", "relax", "self care", "towel", "bath"] },
  { emoji: "🧖‍♂️", keywords: ["man", "sauna", "steam", "spa", "relax", "self care", "towel"] },
  { emoji: "🧖‍♀️", keywords: ["woman", "sauna", "steam", "spa", "relax", "self care", "towel"] },
  { emoji: "💅", keywords: ["nail", "polish", "manicure", "pedicure", "beauty", "salon", "nails", "self care", "grooming"] },
  { emoji: "💄", keywords: ["lipstick", "makeup", "beauty", "cosmetics", "grooming", "face", "glam"] },
  { emoji: "🪞", keywords: ["mirror", "reflection", "look", "beauty", "grooming", "face", "vanity", "check"] },
  { emoji: "👃", keywords: ["nose", "smell", "sniff", "face", "grooming", "clean", "hygiene"] },
  { emoji: "🦷", keywords: ["tooth", "teeth", "dental", "dentist", "brush", "floss", "hygiene", "clean"] },
  { emoji: "🩹", keywords: ["bandage", "bandaid", "wound", "heal", "first aid", "cut", "scrape", "medical"] },
  { emoji: "🩺", keywords: ["stethoscope", "doctor", "checkup", "medical", "health", "appointment"] },
  { emoji: "💊", keywords: ["pill", "medicine", "vitamin", "medication", "health", "pharmacy", "supplement", "daily"] },
  { emoji: "🩻", keywords: ["xray", "medical", "doctor", "bones", "scan", "health", "appointment"] },
  { emoji: "🧏", keywords: ["deaf", "person", "ear", "hearing", "sign language", "accessibility"] },
  { emoji: "🧏‍♂️", keywords: ["deaf", "man", "ear", "hearing", "sign language"] },
  { emoji: "🧏‍♀️", keywords: ["deaf", "woman", "ear", "hearing", "sign language"] },
  { emoji: "🧑‍🦯", keywords: ["person", "cane", "blind", "white cane", "accessibility", "walk"] },
  { emoji: "🛀", keywords: ["bath", "bathing", "person", "tub", "clean", "relax", "hygiene", "soak", "bubble bath"] },
  { emoji: "🚶", keywords: ["walk", "walking", "person", "pedestrian", "exercise", "step", "daily"] },
  { emoji: "🚶‍♂️", keywords: ["man", "walk", "walking", "pedestrian", "exercise", "step"] },
  { emoji: "🚶‍♀️", keywords: ["woman", "walk", "walking", "pedestrian", "exercise", "step"] },
  { emoji: "🏃", keywords: ["run", "running", "person", "jog", "exercise", "sprint", "cardio"] },
  { emoji: "🏃‍♂️", keywords: ["man", "run", "running", "jog", "exercise", "sprint"] },
  { emoji: "🏃‍♀️", keywords: ["woman", "run", "running", "jog", "exercise", "sprint"] },
  ...
  // Country Flags — Americas
  { emoji: "🇺🇸", keywords: ["flag", "usa", "united states", "america", "american", "us", "stars and stripes"] },
  { emoji: "🇨🇦", keywords: ["flag", "canada", "canadian", "maple leaf", "north america"] },
  { emoji: "🇲🇽", keywords: ["flag", "mexico", "mexican", "latin america", "north america"] },
  { emoji: "🇧🇷", keywords: ["flag", "brazil", "brazilian", "south america", "brasil"] },
  { emoji: "🇦🇷", keywords: ["flag", "argentina", "argentinian", "south america"] },
  { emoji: "🇨🇱", keywords: ["flag", "chile", "chilean", "south america"] },
  { emoji: "🇨🇴", keywords: ["flag", "colombia", "colombian", "south america"] },
  { emoji: "🇵🇪", keywords: ["flag", "peru", "peruvian", "south america", "machu picchu"] },
  { emoji: "🇻🇪", keywords: ["flag", "venezuela", "venezuelan", "south america"] },
  { emoji: "🇺🇾", keywords: ["flag", "uruguay", "uruguayan", "south america"] },
  { emoji: "🇧🇴", keywords: ["flag", "bolivia", "bolivian", "south america"] },
  { emoji: "🇪🇨", keywords: ["flag", "ecuador", "ecuadorian", "south america"] },
  { emoji: "🇵🇾", keywords: ["flag", "paraguay", "paraguayan", "south america"] },
  { emoji: "🇬🇹", keywords: ["flag", "guatemala", "guatemalan", "central america"] },
  { emoji: "🇨🇷", keywords: ["flag", "costa rica", "costa rican", "central america"] },
  { emoji: "🇵🇦", keywords: ["flag", "panama", "panamanian", "central america"] },
  { emoji: "🇨🇺", keywords: ["flag", "cuba", "cuban", "caribbean"] },
  { emoji: "🇩🇴", keywords: ["flag", "dominican republic", "dominican", "caribbean"] },
  { emoji: "🇵🇷", keywords: ["flag", "puerto rico", "puerto rican", "caribbean"] },
  { emoji: "🇯🇲", keywords: ["flag", "jamaica", "jamaican", "caribbean"] },

  // Country Flags — Europe
  { emoji: "🇬🇧", keywords: ["flag", "uk", "united kingdom", "britain", "british", "england", "union jack"] },
  { emoji: "🇫🇷", keywords: ["flag", "france", "french", "europe", "paris", "tricolor"] },
  { emoji: "🇩🇪", keywords: ["flag", "germany", "german", "europe", "deutschland"] },
  { emoji: "🇮🇹", keywords: ["flag", "italy", "italian", "europe", "roma", "venice"] },
  { emoji: "🇪🇸", keywords: ["flag", "spain", "spanish", "europe", "madrid", "barcelona"] },
  { emoji: "🇵🇹", keywords: ["flag", "portugal", "portuguese", "europe", "lisbon"] },
  { emoji: "🇳🇱", keywords: ["flag", "netherlands", "dutch", "holland", "europe", "amsterdam"] },
  { emoji: "🇧🇪", keywords: ["flag", "belgium", "belgian", "europe", "brussels"] },
  { emoji: "🇨🇭", keywords: ["flag", "switzerland", "swiss", "europe", "zurich", "alps"] },
  { emoji: "🇦🇹", keywords: ["flag", "austria", "austrian", "europe", "vienna"] },
  { emoji: "🇸🇪", keywords: ["flag", "sweden", "swedish", "scandinavia", "europe", "stockholm"] },
  { emoji: "🇳🇴", keywords: ["flag", "norway", "norwegian", "scandinavia", "europe", "oslo"] },
  { emoji: "🇩🇰", keywords: ["flag", "denmark", "danish", "scandinavia", "europe", "copenhagen"] },
  { emoji: "🇫🇮", keywords: ["flag", "finland", "finnish", "scandinavia", "europe", "helsinki"] },
  { emoji: "🇮🇸", keywords: ["flag", "iceland", "icelandic", "nordic", "europe", "reykjavik"] },
  { emoji: "🇮🇪", keywords: ["flag", "ireland", "irish", "europe", "dublin", "shamrock"] },
  { emoji: "🇬🇷", keywords: ["flag", "greece", "greek", "europe", "athens", "mediterranean"] },
  { emoji: "🇵🇱", keywords: ["flag", "poland", "polish", "europe", "warsaw"] },
  { emoji: "🇨🇿", keywords: ["flag", "czech republic", "czechia", "czech", "europe", "prague"] },
  { emoji: "🇭🇺", keywords: ["flag", "hungary", "hungarian", "europe", "budapest"] },
  { emoji: "🇷🇴", keywords: ["flag", "romania", "romanian", "europe", "bucharest"] },
  { emoji: "🇧🇬", keywords: ["flag", "bulgaria", "bulgarian", "europe", "sofia"] },
  { emoji: "🇭🇷", keywords: ["flag", "croatia", "croatian", "europe", "zagreb", "adriatic"] },
  { emoji: "🇸🇮", keywords: ["flag", "slovenia", "slovenian", "europe", "ljubljana"] },
  { emoji: "🇸🇰", keywords: ["flag", "slovakia", "slovak", "europe", "bratislava"] },
  { emoji: "🇷🇸", keywords: ["flag", "serbia", "serbian", "europe", "belgrade"] },
  { emoji: "🇲🇰", keywords: ["flag", "north macedonia", "macedonian", "europe"] },
  { emoji: "🇦🇱", keywords: ["flag", "albania", "albanian", "europe", "tirana"] },
  { emoji: "🇧🇦", keywords: ["flag", "bosnia", "bosnian", "europe", "sarajevo"] },
  { emoji: "🇲🇪", keywords: ["flag", "montenegro", "montenegrin", "europe", "balkans"] },
  { emoji: "🇺🇦", keywords: ["flag", "ukraine", "ukrainian", "europe", "kyiv"] },
  { emoji: "🇷🇺", keywords: ["flag", "russia", "russian", "europe", "asia", "moscow"] },
  { emoji: "🇧🇾", keywords: ["flag", "belarus", "belarusian", "europe", "minsk"] },
  { emoji: "🇱🇹", keywords: ["flag", "lithuania", "lithuanian", "baltics", "europe", "vilnius"] },
  { emoji: "🇱🇻", keywords: ["flag", "latvia", "latvian", "baltics", "europe", "riga"] },
  { emoji: "🇪🇪", keywords: ["flag", "estonia", "estonian", "baltics", "europe", "tallinn"] },
  { emoji: "🇲🇹", keywords: ["flag", "malta", "maltese", "mediterranean", "europe"] },
  { emoji: "🇨🇾", keywords: ["flag", "cyprus", "cypriot", "mediterranean", "europe"] },
  { emoji: "🇱🇺", keywords: ["flag", "luxembourg", "luxembourgish", "europe"] },
  { emoji: "🇲🇨", keywords: ["flag", "monaco", "monegasque", "europe", "riviera"] },

  // Country Flags — Asia
  { emoji: "🇯🇵", keywords: ["flag", "japan", "japanese", "asia", "tokyo", "nippon"] },
  { emoji: "🇨🇳", keywords: ["flag", "china", "chinese", "asia", "beijing", "prc"] },
  { emoji: "🇰🇷", keywords: ["flag", "south korea", "korean", "asia", "seoul"] },
  { emoji: "🇰🇵", keywords: ["flag", "north korea", "korean", "asia", "pyongyang"] },
  { emoji: "🇮🇳", keywords: ["flag", "india", "indian", "asia", "new delhi", "hindustan"] },
  { emoji: "🇵🇰", keywords: ["flag", "pakistan", "pakistani", "asia", "islamabad"] },
  { emoji: "🇧🇩", keywords: ["flag", "bangladesh", "bangladeshi", "asia", "dhaka"] },
  { emoji: "🇱🇰", keywords: ["flag", "sri lanka", "sri lankan", "asia", "colombo"] },
  { emoji: "🇳🇵", keywords: ["flag", "nepal", "nepali", "asia", "kathmandu", "himalayas"] },
  { emoji: "🇹🇭", keywords: ["flag", "thailand", "thai", "southeast asia", "bangkok"] },
  { emoji: "🇻🇳", keywords: ["flag", "vietnam", "vietnamese", "southeast asia", "hanoi", "ho chi minh"] },
  { emoji: "🇮🇩", keywords: ["flag", "indonesia", "indonesian", "southeast asia", "jakarta", "bali"] },
  { emoji: "🇲🇾", keywords: ["flag", "malaysia", "malaysian", "southeast asia", "kuala lumpur"] },
  { emoji: "🇸🇬", keywords: ["flag", "singapore", "singaporean", "southeast asia"] },
  { emoji: "🇵🇭", keywords: ["flag", "philippines", "filipino", "southeast asia", "manila"] },
  { emoji: "🇲🇲", keywords: ["flag", "myanmar", "burma", "southeast asia", "rangoon"] },
  { emoji: "🇰🇭", keywords: ["flag", "cambodia", "cambodian", "southeast asia", "phnom penh", "angkor"] },
  { emoji: "🇱🇦", keywords: ["flag", "laos", "laotian", "southeast asia", "vientiane"] },
  { emoji: "🇹🇼", keywords: ["flag", "taiwan", "taiwanese", "asia", "taipei"] },
  { emoji: "🇭🇰", keywords: ["flag", "hong kong", "hongkong", "asia", "china"] },
  { emoji: "🇲🇴", keywords: ["flag", "macau", "macao", "asia", "china"] },
  { emoji: "🇲🇳", keywords: ["flag", "mongolia", "mongolian", "asia", "ulaanbaatar"] },
  { emoji: "🇰🇿", keywords: ["flag", "kazakhstan", "kazakh", "central asia"] },
  { emoji: "🇺🇿", keywords: ["flag", "uzbekistan", "uzbek", "central asia", "samarkand"] },
  { emoji: "🇦🇿", keywords: ["flag", "azerbaijan", "azerbaijani", "caucasus", "baku"] },
  { emoji: "🇬🇪", keywords: ["flag", "georgia", "georgian", "caucasus", "tbilisi"] },
  { emoji: "🇦🇲", keywords: ["flag", "armenia", "armenian", "caucasus", "yerevan"] },
  { emoji: "🇮🇷", keywords: ["flag", "iran", "iranian", "persian", "middle east", "tehran"] },
  { emoji: "🇮🇶", keywords: ["flag", "iraq", "iraqi", "middle east", "baghdad"] },
  { emoji: "🇸🇦", keywords: ["flag", "saudi arabia", "saudi", "middle east", "riyadh"] },
  { emoji: "🇦🇪", keywords: ["flag", "uae", "united arab emirates", "dubai", "abu dhabi", "middle east"] },
  { emoji: "🇮🇱", keywords: ["flag", "israel", "israeli", "middle east", "jerusalem", "tel aviv"] },
  { emoji: "🇯🇴", keywords: ["flag", "jordan", "jordanian", "middle east", "amman", "petra"] },
  { emoji: "🇱🇧", keywords: ["flag", "lebanon", "lebanese", "middle east", "beirut"] },
  { emoji: "🇸🇾", keywords: ["flag", "syria", "syrian", "middle east", "damascus"] },
  { emoji: "🇹🇷", keywords: ["flag", "turkey", "türkiye", "turkish", "middle east", "europe", "istanbul", "ankara"] },
  { emoji: "🇾🇪", keywords: ["flag", "yemen", "yemeni", "middle east", "sanaa"] },
  { emoji: "🇴🇲", keywords: ["flag", "oman", "omani", "middle east", "muscat"] },
  { emoji: "🇶🇦", keywords: ["flag", "qatar", "qatari", "middle east", "doha"] },
  { emoji: "🇰🇼", keywords: ["flag", "kuwait", "kuwaiti", "middle east"] },
  { emoji: "🇧🇭", keywords: ["flag", "bahrain", "bahraini", "middle east", "manama"] },
  { emoji: "🇦🇫", keywords: ["flag", "afghanistan", "afghan", "central asia", "kabul"] },

  // Country Flags — Africa
  { emoji: "🇪🇬", keywords: ["flag", "egypt", "egyptian", "africa", "cairo", "pyramids"] },
  { emoji: "🇿🇦", keywords: ["flag", "south africa", "south african", "africa", "cape town", "johannesburg"] },
  { emoji: "🇳🇬", keywords: ["flag", "nigeria", "nigerian", "africa", "lagos", "abuja"] },
  { emoji: "🇰🇪", keywords: ["flag", "kenya", "kenyan", "africa", "nairobi", "safari"] },
  { emoji: "🇹🇿", keywords: ["flag", "tanzania", "tanzanian", "africa", "dar es salaam", "kilimanjaro"] },
  { emoji: "🇪🇹", keywords: ["flag", "ethiopia", "ethiopian", "africa", "addis ababa"] },
  { emoji: "🇬🇭", keywords: ["flag", "ghana", "ghanaian", "africa", "accra"] },
  { emoji: "🇸🇳", keywords: ["flag", "senegal", "senegalese", "africa", "dakar"] },
  { emoji: "🇲🇦", keywords: ["flag", "morocco", "moroccan", "africa", "marrakech", "casablanca", "rabat"] },
  { emoji: "🇩🇿", keywords: ["flag", "algeria", "algerian", "africa", "algiers"] },
  { emoji: "🇹🇳", keywords: ["flag", "tunisia", "tunisian", "africa", "tunis"] },
  { emoji: "🇱🇾", keywords: ["flag", "libya", "libyan", "africa", "tripoli"] },
  { emoji: "🇨🇮", keywords: ["flag", "ivory coast", "cote d'ivoire", "ivorian", "africa", "abidjan"] },
  { emoji: "🇨🇲", keywords: ["flag", "cameroon", "cameroonian", "africa", "yaounde"] },
  { emoji: "🇺🇬", keywords: ["flag", "uganda", "ugandan", "africa", "kampala"] },
  { emoji: "🇷🇼", keywords: ["flag", "rwanda", "rwandan", "africa", "kigali"] },
  { emoji: "🇲🇿", keywords: ["flag", "mozambique", "mozambican", "africa"] },
  { emoji: "🇿🇲", keywords: ["flag", "zambia", "zambian", "africa", "lusaka"] },
  { emoji: "🇿🇼", keywords: ["flag", "zimbabwe", "zimbabwean", "africa", "harare"] },
  { emoji: "🇧🇼", keywords: ["flag", "botswana", "botswanan", "africa", "gaborone"] },
  { emoji: "🇳🇦", keywords: ["flag", "namibia", "namibian", "africa", "windhoek"] },
  { emoji: "🇲🇬", keywords: ["flag", "madagascar", "malagasy", "africa", "antananarivo"] },
  { emoji: "🇸🇩", keywords: ["flag", "sudan", "sudanese", "africa", "khartoum"] },
  { emoji: "🇸🇸", keywords: ["flag", "south sudan", "south sudanese", "africa", "juba"] },
  { emoji: "🇸🇴", keywords: ["flag", "somalia", "somali", "africa", "mogadishu"] },
  { emoji: "🇦🇴", keywords: ["flag", "angola", "angolan", "africa", "luanda"] },
  { emoji: "🇨🇩", keywords: ["flag", "dr congo", "democratic republic of congo", "drc", "africa", "kinshasa"] },
  { emoji: "🇨🇬", keywords: ["flag", "republic of congo", "congo", "africa", "brazzaville"] },

  // Country Flags — Oceania & Pacific
  { emoji: "🇦🇺", keywords: ["flag", "australia", "australian", "oceania", "sydney", "melbourne", "aussie"] },
  { emoji: "🇳🇿", keywords: ["flag", "new zealand", "kiwi", "oceania", "auckland", "wellington"] },
  { emoji: "🇫🇯", keywords: ["flag", "fiji", "fijian", "pacific", "oceania"] },
  { emoji: "🇵🇬", keywords: ["flag", "papua new guinea", "png", "pacific", "oceania"] },
  { emoji: "🇸🇧", keywords: ["flag", "solomon islands", "pacific", "oceania"] },
  { emoji: "🇻🇺", keywords: ["flag", "vanuatu", "pacific", "oceania"] },
  { emoji: "🇼🇸", keywords: ["flag", "samoa", "samoan", "pacific", "oceania"] },
  { emoji: "🇹🇴", keywords: ["flag", "tonga", "tongan", "pacific", "oceania"] },
  { emoji: "🇵🇫", keywords: ["flag", "french polynesia", "tahiti", "pacific", "bora bora"] },
  { emoji: "🇳🇨", keywords: ["flag", "new caledonia", "pacific", "france"] },
  ...
  // Spooky / Horror
  { emoji: "👾", keywords: ["monster", "alien", "space invader", "spooky", "game", "creature", "scary"] },
  { emoji: "🧟", keywords: ["zombie", "undead", "spooky", "horror", "halloween", "monster", "scary", "walking dead"] },
  { emoji: "🧟‍♂️", keywords: ["zombie", "man", "undead", "spooky", "horror", "halloween", "monster", "scary"] },
  { emoji: "🧟‍♀️", keywords: ["zombie", "woman", "undead", "spooky", "horror", "halloween", "monster", "scary"] },
  { emoji: "🧌", keywords: ["troll", "monster", "creature", "spooky", "fantasy", "ugly", "scary"] },
  { emoji: "🧞", keywords: ["genie", "magic", "wish", "fantasy", "lamp", "spirit", "djinn"] },
  { emoji: "🕸️", keywords: ["spider web", "web", "cobweb", "spooky", "halloween", "creepy", "dusty"] },
  { emoji: "⚰️", keywords: ["coffin", "casket", "death", "dead", "funeral", "spooky", "halloween", "grave"] },
  { emoji: "⚱️", keywords: ["urn", "ashes", "funeral", "death", "memorial", "spooky"] },
  { emoji: "🪦", keywords: ["headstone", "tombstone", "grave", "gravestone", "rip", "death", "cemetery", "spooky", "halloween"] },
  { emoji: "🌑", keywords: ["new moon", "dark", "night", "black", "spooky", "moon"] },
...
const EMOJI_CATEGORIES: Record<string, string[]> = {
  "Common": ["📝", "📋", "📌", "✏️", "📖", "📚", "💡", "🎯", "⭐", "🌟", "💪", "🚀", "🔥", "⚡", "💎", "🏆", "🎉", "✅", "❤️", "💛", "💚", "💙", "💜", "🧡", "❗", "❓", "😀", "😊", "😎", "🤔", "✨", "💯", "👀", "🫶"],
  "Appearance": ["💇", "💇‍♂️", "💇‍♀️", "💈", "🪮", "💆", "💆‍♂️", "💆‍♀️", "🧖", "🪒", "💅", "💄", "🪞", "🧴", "🧼", "🧑", "👨", "👩", "🧔", "🧔‍♂️", "👱‍♂️", "👱‍♀️", "👨‍🦰", "👩‍🦰", "👨‍🦱", "👩‍🦱", "👨‍🦳", "👩‍🦳", "👨‍🦲", "👩‍🦲", "🧑‍🦰", "🧑‍🦱", "🧑‍🦳", "🧑‍🦲", "😀", "🙂", "😎", "🤳", "👤", "🕶️", "👓", "🧢", "🎩", "👒", "👔", "👗", "👠", "💍"],
  "Spooky": ["💀", "☠️", "👻", "🎃", "😈", "👿", "👹", "👺", "🤡", "🤖", "👽", "👾", "🧟", "🧟‍♂️", "🧟‍♀️", "🧛‍♂️", "🧛‍♀️", "🧙‍♂️", "🧙‍♀️", "🧌", "🧞", "🦇", "🕷️", "🕸️", "🦂", "🐍", "🐀", "🦉", "⚰️", "⚱️", "🪦", "🔮", "🧿", "🗡️", "⚔️", "🩸", "🦴", "🥀", "🌑", "🕯️", "🌫️", "🍄", "⛓️"],
  "Faces": ["😀", "😊", "😎", "🤔", "😴", "😤", "🥳", "🤩", "😇", "🥰", "😂", "🥲", "😏", "😡", "😱", "🤯", "🫠", "🥸", "🤠", "😈", "��", "🤓", "🧐", "🤫", "🤥", "😬", "🙄", "🥱", "🤗", "🤑", "🤢", "🤮", "🥴", "🥵", "🥶", "🤧", "😵", "😵‍💫", "😶", "😐", "😑", "😒", "😔", "😕", "🙁", "☹️", "😣", "😖", "😫", "😩", "🥺", "😢", "😭", "😠", "🤡", "👹", "👺", "💀", "☠️", "👻", "🫨", "🫣", "🫥", "😮‍��", "😶‍🌫️", "🫡"],
  "People": ["👨", "👩", "�", "👶", "�", "👦", "👧", "👴", "👵", "🧓", "�🧔", "👨‍🦰", "👨‍🦱", "👨‍🦳", "👨‍🦲", "�‍🦰", "�‍🦱", "�‍🦳", "👩‍🦲", "�👱‍♂️", "👱‍♀️", "👨🏻", "👨🏽", "👨🏾", "👨🏿", "👩🏻", "👩🏽", "👩🏾", "👩🏿", "👶🏻", "👶🏽", "👶🏾", "👶🏿", "👧🏻", "👧🏽", "👧🏾", "�🏻", "👦🏽", "👦🏾", "🤴", "👸", "👰", "🤵", "�", "🫅", "👼", "🤰", "🤱", "👨‍🍼", "👩‍🍼", "🧑‍🍼", "🫄", "👪", "👨‍👩‍👦", "👨‍👩‍👧", "👨‍👩‍👧‍👦", "👨‍👩‍👦‍👦", "👨‍👩‍👧‍👧", "👩‍👦", "👩‍�", "👩‍👧‍👦", "�‍👦", "👨‍�", "👨‍👧‍�", "👨‍👨‍👦", "👩‍�‍👦", "👫", "👬", "👭", "💑", "💏", "�‍🤝‍🧑"],
  "Roles": ["🧑‍💻", "👨‍💻", "👩‍💻", "🧑‍🏫", "👨‍🏫", "👩‍🏫", "�‍⚕️", "👨‍⚕️", "👩‍⚕️", "🧑‍🍳", "👨‍🍳", "👩‍🍳", "�‍🔧", "👨‍🔧", "👩‍🔧", "🧑‍🌾", "👨‍🌾", "👩‍🌾", "�‍🎓", "👨‍🎓", "👩‍🎓", "🧑‍🎤", "👨‍🎤", "👩‍🎤", "�‍🚒", "👨‍🚒", "👩‍🚒", "👷", "👷‍♂️", "👷‍♀️", "👮", "👮‍♂️", "👮‍♀️", "🕵️", "🕵️‍♂️", "🕵️‍♀️", "💂", "💂‍♂️", "💂‍♀️", "�‍✈️", "�‍✈️", "�‍✈️", "🧑‍🚀", "�‍🚀", "👩‍�", "🧑‍⚖️", "�‍⚖️", "�‍⚖️", "🧑‍🎨", "🧑‍�", "🧙‍♀️", "🧙‍♂️", "�‍♀️", "�‍♂️", "�‍♀️", "�‍♂️", "🦹‍♀️", "🦹‍♂️"],
  "Work": ["💼", "🏢", "💻", "🖥️", "📊", "📈", "📧", "📞", "📱", "📅", "⏰", "⏳", "🔔", "💰", "💵", "��", "🤝", "👔", "🎤", "🖨️", "📤", "📥", "🧑‍💻", "🧑‍💼", "📣", "🗂️", "📁", "⌨️", "🖱️", "💾", "📡", "🌐"],
  "Health": ["🏃", "🧘", "💊", "🩺", "🏋️", "🚴", "🏊", "🧠", "🍎", "🥗", "💧", "❤️‍🩹", "🦷", "👁️", "💉", "🧬", "🌿", "😴", "💤", "🩹", "🏥", "🧑‍⚕️", "🫀", "🫁", "🧴"],
  "Medical": ["😷", "🤒", "🤕", "🤧", "🩻", "🩹", "🏥", "🚑", "🩸", "💉", "🩺", "💊", "🫁", "🫀", "🧠", "🦷", "🦴", "🩼", "🦽", "🦼", "🦯", "🧬", "🔬", "🧪", "⚗️", "🧴", "🌡️", "❤️‍🩹", "🧑‍⚕️", "👨‍⚕️", "👩‍⚕️"],
  "Learn": ["📖", "📚", "��", "🧪", "🔬", "🔭", "🌍", "🎨", "🎵", "🎹", "🎸", "📐", "🧮", "🔢", "✍️", "💬", "🗣️", "🧑‍🎓", "🧑‍🏫", "🧑‍🔬"],
